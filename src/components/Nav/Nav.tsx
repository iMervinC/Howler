...
const Nav: FC<any> = ({ navigation }) => {
  ...
  return (
    <>
      <nav className="w-sideM md:min-w-side flex flex-col justify-end h-screen px-0">
        {/* Logo */}
        <div className="flex items-center h-20 justify-center md:justify-start ">
          <Link href="/home">
            <a>
              <img
                className="h-10 hidden md:block hover-shadow"
                src="/logo.svg"
                alt="logo"
              />
              <img
                className="block md:hidden hover-shadow"
                src="/pic1.svg"
                alt="logo"
              />
            </a>
        ...
        {/* Navigations */}
        <ul className="text-xl font-bold md:ml-3 flex flex-col gap-4">
          {/* Home Link */}
          <li>
            <Link href="/home">
              <a
          ...
          <li>
            <Link href="/[user]" as={`/${sessionUser?.userTag}`}>
              ...
              >
                ...
                <p className="ml-2 hidden md:block">Profile</p>
              </a>
            </Link>
          </li>
          <li>
